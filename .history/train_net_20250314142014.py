...
from SAMFinetuner import SAMFinetuner
...
class Coco2MaskDataset(Dataset):
    def __init__(self, data_root, split, image_size=1024, annotation_name="annotations.json", length=150, num_points=4, use_centerpoint=False):
        self.data_root = data_root
        self.split = split
        self.image_size = image_size
        self.use_centerpoint = use_centerpoint
        self.length = length
        annotation = os.path.join(data_root, split, annotation_name)
