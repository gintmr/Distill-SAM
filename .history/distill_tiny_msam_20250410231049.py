...
def main():
    ...
    parser.add_argument("--S_checkpoint_path", default="/data2/wuxinrui/RA-L/MobileSAM/weights/weights_prune_init/pruned_weights.pth", type=str, required=False, help="path to the checkpoint")
