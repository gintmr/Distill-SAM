...
def main():
    ...
    parser.add_argument("--checkpoint_path", type=str, default="//data2/wuxinrui/RA-L/MobileSAM/trained_models/wxr_modified_mobilesam/final_model.pth", help="path to the checkpoint")
