...
def main():
    ...
    parser.add_argument("--checkpoint_path", default="/data2/wuxinrui/RA-L/MobileSAM/trained_models/wxr_modified_mobilesam/last-v5.ckpt", type=str, required=False, help="path to the checkpoint")
    ...
    parser.add_argument("--learning_rate", type=float, default=3.0e-5, help="learning rate")
