...
def main():
    ...
    parser.add_argument("--Tar", default="Img_Encoder", type=str, required=False, help="target to be distilled")
    ...
    trainer.fit(model)
    torch.save(model.model.state_dict(), os.path.join(output_dir, save_dir))
