...
class MobileSAMFintuner(pl.LightningModule):
        ...
        try:
            ...
            for feature, bbox, label, center_point, point_label, target_label, original_input_size_item, resized_input_size_item, coco_image_name, img in \
                ...
                if random.random() < 0.01:
                    ...
                    output_path_combined = os.path.join(training_visual_path, f"{step}_{coco_image_name.replace(ext_name, '_combined.png')}")
                    ...
                    combine_visualize_results(pred_mask_array, GT_mask_array, point_array, output_path_pred.replace('_pred.png', '.png'))
    ...
    def validation_epoch_end(self, outputs):
        ...
        len_val = len(outputs)
        losses = sum([output['loss'] for output in outputs])
