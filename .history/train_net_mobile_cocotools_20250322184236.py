    ...
    def __getitem__(self, index):
        try:
            ...
            for annotation in annotations[:self.length]:
                ...
                #G assert mask.shape == resized_input_size
                assert mask.shape == original_input_size
...
def main():
    ...
    parser.add_argument("--output_dir", type=str, default="./trained_models/new_mimc", help="path to save the model")
    ...
    parser.add_argument("--log_dir", default="./metrics_logs/new_mimc")
