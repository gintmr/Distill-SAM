...
def main():
    ...
    parser.add_argument("--checkpoint_path", default="/data2/wuxinrui/RA-L/MobileSAM/trained_models/wxr_modified_mobilesam/final_model.pth", type=str, required=False, help="path to the checkpoint")
    ...
    parser.add_argument("--length", type=int, default=5, help="the length of the chosen masks")
