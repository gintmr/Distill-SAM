...
class Coco2MaskDataset(Dataset):
    ...
    def __init__(self, data_root, image_size=1024, annotation_path=None, length=150, num_points=4, use_centerpoint=False):
        ...
        self.imgIds = self.coco.getImgIds()  # 获取所有图像的 ID
...
def main():
    ...
    # parser.add_argument("--train_anno", default="/data2/wuxinrui/Projects/ICCV/MIMC_FINAL/train-taxonomic_cleaned_polygon_sampled_5000.json", type=str, required=False, help="path to the annotation file")
    ...
    # parser.add_argument('--val_anno', default="/data2/wuxinrui/Projects/ICCV/MIMC_FINAL/val-taxonomic_cleaned_polygon_sampled_2000.json", )
    ...
    parser.add_argument("--train_anno", default="/data2/wuxinrui/Datasets/COCO/annotations/instances_train2017_sampled_5000_polygon.json", type=str, required=False, help="path to the annotation file")
    ...
    parser.add_argument('--val_anno', default="/data2/wuxinrui/Datasets/COCO/annotations/instances_val2017_sampled_2000_polygon.json", type=str, required=False, help="path to the annotation file")
    

    
    parser.add_argument("--model_type", default='vit_t', type=str, required=False, help="model type")
    parser.add_argument("--checkpoint_path", default="weights/fixed_mobile_sam.pt", type=str, required=False, help="path to the checkpoint")
    ...
    trainer.validate(model=model, dataloaders=val_dataloader, ckpt_path=args.weights/fixed_mobile_sam.pt)
