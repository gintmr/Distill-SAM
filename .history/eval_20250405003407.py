...
def main():
    ...
    parser.add_argument("--model_type", type=str, default="vit_t", help="model type", choices=["vit_h", "vit_h","tiny_msam"])
    # parser.add_argument("--checkpoint_path", type=str, default="/data2/wuxinrui/RA-L/MobileSAM/trained_models/standard_mimc/last-v6.ckpt", help="path to the checkpoint")
