...
def main():
    ...
    parser.add_argument("--checkpoint_path", default="/data2/wuxinrui/RA-L/MobileSAM/trained_models/wxr_modified_mobilesam/random_point_v2.ckpt", type=str, required=False, help="path to the checkpoint")
