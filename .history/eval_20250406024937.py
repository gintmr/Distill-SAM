...
def main():
    ...
    parser.add_argument("--checkpoint_path", type=str, default="/data2/wuxinrui/RA-L/MobileSAM/trained_models/wxr_modified_mobilesam/last-v5.ckpt", help="path to the checkpoint")
    ...
    log_filename = "/data2/wuxinrui/RA-L/MobileSAM/baseline_eval/eval.log"
    logging.basicConfig(
    ...
    logging.info(f"INFERENCE_MODE = {os.environ['INFERENCE_MODE']}")
    ...
    for img_file in tqdm(img_files[:50], miniters=50):
        ...
        point_metric_dict = calculate_metrics(bbox_pred_masks, image_masks)
