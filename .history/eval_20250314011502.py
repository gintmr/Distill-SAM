...
def main():
    ...
    for img_file in tqdm(img_files):
        ...
        results_dict = inference_image(img_path, annotations, generator=False, predictor=True, bbox_prompt=True, point_prompt=True, model_type=args.model_type, sam_checkpoint=args.checkpoint_path, device=device)
