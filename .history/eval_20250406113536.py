...
def main():
    ...
    parser.add_argument("--checkpoint_path", type=str, default="/data2/wuxinrui/RA-L/MobileSAM/trained_models/wxr_modified_mobilesam/last-v7.ckpt", help="path to the checkpoint")
