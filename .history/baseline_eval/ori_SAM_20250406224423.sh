...
#g 原生SAM 1,3,5,bbox
python /data2/wuxinrui/RA-L/MobileSAM/eval.py --checkpoint_path /data2/wuxinrui/RA-L/MobileSAM/weights/sam_vit_h_4b8939.pth --ori_SAM True --model_type vit_h --label_num 1.0 --visualize_mask_path /data2/wuxinrui/RA-L/MobileSAM/baseline_eval/ori_SAM

python /data2/wuxinrui/RA-L/MobileSAM/eval.py --checkpoint_path /data2/wuxinrui/RA-L/MobileSAM/weights/sam_vit_h_4b8939.pth --ori_SAM True --model_type vit_h --label_num 3.0 --visualize_mask_path /data2/wuxinrui/RA-L/MobileSAM/baseline_eval/ori_SAM

python /data2/wuxinrui/RA-L/MobileSAM/eval.py --checkpoint_path /data2/wuxinrui/RA-L/MobileSAM/weights/sam_vit_h_4b8939.pth --ori_SAM True --model_type vit_h --label_num 5.0 --visualize_mask_path /data2/wuxinrui/RA-L/MobileSAM/baseline_eval/ori_SAM
