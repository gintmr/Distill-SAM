...
python /data2/wuxinrui/RA-L/MobileSAM/eval.py --checkpoint_path /data2/wuxinrui/RA-L/MobileSAM/trained_models/wxr_modified_mobilesam/random_point_v2_bbox.pth --label_num 1.0 --visualize_mask_path /data2/wuxinrui/RA-L/MobileSAM/baseline_eval/temp

python /data2/wuxinrui/RA-L/MobileSAM/eval.py --checkpoint_path /data2/wuxinrui/RA-L/MobileSAM/trained_models/wxr_modified_mobilesam/random_point_v2_bbox.pth --label_num 3.0 --visualize_mask_path /data2/wuxinrui/RA-L/MobileSAM/baseline_eval/temp

python /data2/wuxinrui/RA-L/MobileSAM/eval.py --checkpoint_path /data2/wuxinrui/RA-L/MobileSAM/trained_models/wxr_modified_mobilesam/random_point_v2_bbox.pth --label_num 5.0 --visualize_mask_path /data2/wuxinrui/RA-L/MobileSAM/baseline_eval/temp
