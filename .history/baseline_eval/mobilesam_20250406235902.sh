...
python /data2/wuxinrui/RA-L/MobileSAM/eval.py --checkpoint_path /data2/wuxinrui/RA-L/MobileSAM/weights/mobile_sam.pt --label_num 5 --visualize_mask_path /data2/wuxinrui/RA-L/MobileSAM/baseline_eval/mobtestilesam
