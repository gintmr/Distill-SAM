...
checkpoint = torch.load("/data2/wuxinrui/RA-L/MobileSAM/trained_models/Distilled_encoder/last.ckpt", map_location="cuda")
...
torch.save(save_checkpoint, "/data2/wuxinrui/RA-L/MobileSAM/trained_models/Distilled_encoder/Distilled")