...
class MobileSAMFintuner(pl.LightningModule):
    ...
    def forward(self, imgs, bboxes, labels, center_points, point_labels, target_labels, original_input_size, resized_input_size, coco_image_name):
        device = imgs.device
        imgs.to("cpu")
        ...
        try:
            ...
            # 获取图片名称
            img_names = [self.train_dataset.get_image_name(idx) for idx in range(self.batch_size)]
