...
mask_generator, mask_predictor = init_model(model_type="vit_t", sam_checkpoint="./weights/mobile_sam.pt", device="cuda", generator=True, predictor=False)
# 遍历文件夹中的所有图片
for filename in os.listdir(input_folder)[:10]:
    if filename.endswith(('.jpg', '.jpeg', '.png')):
        ...
        results_dict = inference_image(image_path=image_path, mask_generator=mask_generator, device="cuda")
