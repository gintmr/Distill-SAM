...
for filename in os.listdir(input_folder)[:10]:
    if filename.endswith(('.jpg', '.jpeg', '.png')):
        ...
        results_dict = inference_image(image_path=image_path, annotations=annotations, mask_generator=mask_generator,mask_predictor=mask_predictor, device="cuda", point_prompt=True)
