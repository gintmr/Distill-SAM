...
def main():
    ...
    for img_file in tqdm(img_files):
        ...
        generator_results, predictor_results, image_annotations, image_masks, img_name, img_h, img_w = inference_image(img_path, annotations, generator=False, predictor=True, bbox_prompt=True, point_prompt=True, model_type=args.model_type, sam_checkpoint=args.checkpoint_path, device=device)
