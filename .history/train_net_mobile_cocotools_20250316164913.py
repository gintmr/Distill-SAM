...
class Coco2MaskDataset(Dataset):
    ...
    def __init__(self, annotation_file, data_root, transform, length, num_points, use_centerpoint):
        self.coco = COCO(annotation_file)  # 使用 pycocotools 加载 COCO 数据集
