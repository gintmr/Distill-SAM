...
process_images_and_annotations(cocoed_anno, image_folder_path, "/data2/wuxinrui/RA-L/MobileSAM/NEW_MIMC/images/val", "/data2/wuxinrui/RA-L/MobileSAM/NEW_MIMC/annotations/val.json", max_size=512, seg_type="rle")