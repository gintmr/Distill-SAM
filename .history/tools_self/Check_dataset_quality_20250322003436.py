...
anno_path = "/data2/wuxinrui/Projects/ICCV/MIMC_FINAL/train-taxonomic_cleaned.json"
image_folder_path = "/data2/wuxinrui/Projects/ICCV/MIMC_FINAL/seen/train_list"

cocoed_anno = COCO(anno_path)

process_images_and_annotations(cocoed_anno, image_folder_path, output_image_folder, output_anno_path, max_size=640, seg_type="rle")
...
def resize_annotations(annotations, scale, seg_type):
    """
    ...
    for ann in annotations:
        ...
        if 'segmentation' in ann:
            if seg_type == 'poly':
                ...
                ann['segmentation'] = COCO.maskToRLE(mask)
...
def process_images_and_annotations(cocoed_anno, image_folder_path, output_image_folder, output_anno_path, max_size=640, seg_type="rle"):
    ...
    for imgId in tqdm(imgIds):
        ...
        resized_annotations = resize_annotations(annotations, scale)
...
process_images_and_annotations(cocoed_anno, image_folder_path, "/data2/wuxinrui/RA-L/MobileSAM/tools_self/cleaned_images", "/data2/wuxinrui/RA-L/MobileSAM/tools_self/cleaned_annotations.json", max_size=640, seg_type="rle")