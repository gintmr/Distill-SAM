...
def process_images_and_annotations(cocoed_anno, image_folder_path, output_image_folder, output_anno_path, max_size=720, seg_type="rle"):
    """
...
process_images_and_annotations(cocoed_anno, image_folder_path, "/data2/wuxinrui/RA-L/MobileSAM/NEW_MIMC/images/train", "/data2/wuxinrui/RA-L/MobileSAM/NEW_MIMC/annotations/train.json")
