...
def main():
    ...
    parser.add_argument("--train_anno", default="/data2/wuxinrui/Projects/ICCV/MIMC_FINAL/train-taxonomic_cleaned_polygon_sampled_50.json", type=str, required=False, help="path to the annotation file")
    ...
    parser.add_argument('--val_anno', default="/data2/wuxinrui/Projects/ICCV/MIMC_FINAL/val-taxonomic_cleaned_polygon_sampled_10.json", )
